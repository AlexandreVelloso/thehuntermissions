...
async function findMissionBy(column: string, value: string) {
...
async function findMissionByAnimal(animalId: string, missionName: string) {
    return MissionModel.query()
...
async function findAnimalBy(column: string, value: string) {
...
exports.seed = function seed(knex: Knex) {
    Model.knex(knex);
